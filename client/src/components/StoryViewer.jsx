...
const StoryViewer = ({viewStory,setViewStory}) => {
    ...
    const renderContent = ()=>{
        ...
        switch (viewStory.media_type) {
            case 'image':
                  return (
                    <img src={viewStory.media_url} className='max-w-full max-h-screen
                    object-contain' />
                  )  ;
                    case 'video':
                  return (
  ...
  return (
    ...
    style={{backgroundColor:viewStory.media_type === 'text' ? 
        ...
        h-1 bg-gray-700'>
            <div className='h-full bg-white transition-all duration-100 bg-linear
        ...
        p-2 px-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50'>
