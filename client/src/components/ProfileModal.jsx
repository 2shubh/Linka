        ...
        <div className='bg-white rounded-lg shadow p-6 '>
          ...
          <form className='space-y-4' onSubmit={handleSaveprofile}>
            ...
            className='block text-sm font-medium text-gray-700 mb-1' >
               Profile Picture
              <input type='file' hidden accept='images/*' id='profile_picture'
                 ...
                 onChange={(e)=>setEditForm({...editForm , cover_photo:e.target.files[0]
                  ...
                  <div className='group/cover relative'>
                    <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo)
                      ...
                      top-0 left-0 bottom-0 right-0 bg-black/20 rounded-lg
            ...
            <div >
              ...
              <div className='flex justify-end space-x-3 pt-6'>
                ...
                text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'>Cancle</button>
                <button type='submit' className='px-4 py-2 bg-gradient-to-r from-indigo-500
                to-purple-700 text-white rounded-lg
