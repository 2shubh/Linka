        ...
        if(file.type.startsWith('video')){
            ...
            video.onloadedmetadata = ()=>{
                ...
                if(video.duration > MAX_VIDEO_DURATION){
                    toast.error("Video duration is greater than 1 minute")
                    setMedia(null)
                    setPreviewUrl(null)
                }else{
                     setMedia(file)
        ...
        <div className='w-full max-w-md'>
            ...
            <div className='rounded-lg h-96 flex items-center justify-center relative'
                 ...
                 {mode === 'text' && (
                    ...
                    h-full p-6 text-lg resize-none focus:outline-none' 
            ...
            <div className='flex gap-2 mt-4'>
                <button onClick={()=> {setMode('text'); setMedia(null); setPreviewUrl(null) }} className={` flex-1 flex items-center justify-center
                    gap-2 p-2 rounded cursor-pointer ${mode == 'text' ? "bg-white text-black" : "bg-zinc-800"}`}>
