...
console.log("Looking for userId:", userId);
  ...
  return (
    ...
    bg-gradient-to-r from-indigo-50 to-purple-50 border-b 
    border-gray-300 "
        >
          <img
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 -my-1.5"> @{user.username}</p>
          </div>
        </div>
        ...
        <div className="px-4 ">
           ...
           bg-white w-full max-w-xl mx-auto border border-gray-200
